...
do
    ...
    sbatch --job-name "q$n_qubits-n$1-c$2-s$3" ./slurm_job.sh "data.omegas=$n_qubits,model.n_qubits=$n_qubits,model.noise_params.$1=0.03,model.circuit_type=$2,seed=$3" &
done