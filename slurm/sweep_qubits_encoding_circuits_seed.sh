...
do
    ...
    sbatch --job-name "q$n_qubits-e$1-c$2-s$3" ~/effect-of-noise-in-qfms/slurm/slurm_job.sh "data.omegas=$n_qubits,model.n_qubits=$n_qubits,model.encoding=$1,model.circuit_type=$2,seed=$3" &
done